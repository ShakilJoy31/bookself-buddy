...
exports.getSpecificBookById = exports.getBooks = exports.getUsers = exports.createBooks = exports.createUser = void 0;
...
const getBooks = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield (0, bookself_service_1.getBooksFromDB)();
    console.log(user);
    console.log('hello');
    res.status(200).json({
        status: 'success',
